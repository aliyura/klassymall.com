...
<html lang="en">
<head>
<title>Klasy Mall [New Orders]</title>
<meta charset="utf-8">
...
<link rel="stylesheet" type="text/css" href="styles/_orders.css">
			...
			<div class="row">
				<div class="col-lg-12 offset-lg-1 shopping-cart-wrapper">
					<div class="cart_container">
						<div class="cart_title">New Orders</div>
                        <div class="order-search-wrapper">
                            <input type="text" placeholder="Search e.g  order number, customer name or customer mobile number e.t.c " class="form-control order-search-in">
                            <button type="button" class="order-search-btn">Search</button>
                        </div>
						<div class="cart_items">
							<ul class="cart_list" name="ordersPanel">
...
<script type="text/javascript" src="js/ui/KM.orders-ui.js"></script>
