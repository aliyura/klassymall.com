...
<html lang="en">
<head>
<title>Klasy Mall [Published Successfully]</title>
<meta charset="utf-8">
     ...
     <div class="container">
      <div class="row">
        <section class="orderDetails-body">
               ...
               <h2 align="center"> Published Successfully</h2>
           </div>       
             <a href="add-item"><button type="button" class="btn btn-default right"> <i class="fa fa-plus"></i> Add More</button></a>
        </section>
        </div>
    </div>
